...
python ./runPerformanceTests.py --stancflags "\"--O\"" --check-golds-exact 1e-8 $1 --scorch-earth && python ./comparePerformance.py "reference_performance.csv" performance.csv csv
#python ./runPerformanceTests.py --check-golds-exact 1e-8 $1 --scorch-earth && python ./comparePerformance.py "reference_performance.csv" performance.csv csv
